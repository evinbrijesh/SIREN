...
- **`baseline_water_mask.tif` is in the wrong valley:** it covers the Rolwaling area ~30 km west of the AOI — never use it as an Imja lake reference; the union of `obs-*_expansion_mask.tif` is the georeferenced lake footprint.
